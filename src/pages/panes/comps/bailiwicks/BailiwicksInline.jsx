...
import {BAILIWICK_MODE_INLINE} from "settings/BailiwickSettings";
...
export class BailiwicksInline extends Component {
   ...
   render() {
      const {inline_bailiwicks, bailiwick_index, sort_column_id, sort_ascending} = this.state
